...
>
> **Destinations:**
> - 1st Squad → OBJ PYTHON (vic MP 0600 1523) — VIPER leadership element at Arcadia / Bradenton junction
> - 2nd Squad → OBJ MAMBA (vic MP 0602 1565) — VIPER leadership element at Bradenton / Jacksonville junction
> - 3rd Squad → OBJ COBRA (vic MP 0611 1530) — VIPER leadership element in Conex City center
>
...
> - Deploy one VIPER leadership element (3-4 personnel) per objective: 1-2 "leaders" (seated with maps/notebooks, phones) and 2 bodyguards in fighting positions.
> - Props: map with markings, notebooks, a cell phone or handheld radio.
> - Bodyguards fight hard. Leaders attempt to destroy planning materials and escape.
> - Introduce a civilian near one position to test ROE.
...
**2. Disposition.** VIPER leadership elements are dispersed across the AO:
   - A cell leadership position on the north side of Arcadia Street at the Bradenton Avenue junction (vic MP 0600 1523). Bodyguards oriented south and southwest along Bradenton.
   - A cell leadership position at the Bradenton Avenue / Jacksonville Street intersection (vic MP 0602 1565). Bodyguards oriented south along Bradenton. Dense woods to the north provide a withdrawal route.
   - A cell leadership position working from a structure in Conex City center (vic MP 0611 1530). Bodyguards at entrances; leaders inside.
...
- **TASK:** Attack to seize OBJ PYTHON (MP 0600 1523), destroy the VIPER leadership element at the Arcadia / Bradenton junction, and exploit captured planning materials, maps, notebooks, and cell phones.
...
- **TASK:** Attack to seize OBJ MAMBA (MP 0602 1565), destroy the VIPER leadership element at the Bradenton / Jacksonville junction, and exploit captured planning materials, maps, notebooks, and cell phones.
...
- **TASK:** Attack to seize OBJ COBRA (MP 0611 1530), destroy the VIPER leadership element operating out of the Conex City center structure, and exploit captured planning materials, maps, notebooks, and cell phones.
...
*Priority Intelligence Requirements (PIR — enemy, terrain, weather, civil):*
   ...
   4. Assess civilian presence near each objective; report civilian presence preventing planned actions.
   5. Enemy strength at any objective significantly different from the estimate.
   6. VIPER leadership observed departing position before the assault.
   7. VIPER bodyguards destroying or removing materials.
   8. VIPER reaction element approaching any objective.

*Friendly Force Information Requirements (FFIR — our own force):*
   1. Friendly casualty requiring immediate MEDEVAC.
