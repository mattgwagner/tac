...
*Priority Intelligence Requirements (PIR — enemy, terrain, weather, civil):*
   ...
   5. Initial contact with VIPER forces in any zone — report size, activity, location, and weapons immediately.
   6. VIPER forces massing against a single squad from multiple zones.
