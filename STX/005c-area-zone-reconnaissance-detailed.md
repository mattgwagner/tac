...
**2. Disposition.** VIPER elements are suspected at three locations:
   ...
   - A suspected VIPER waypoint at the Arcadia Street / Clearwater Avenue intersection (vic MP 0575 1524). Likely using vegetation for concealment while staging for movement.
...
*Priority Intelligence Requirements (PIR — enemy, terrain, weather, civil):*
   ...
   6. Discovery of prepared fighting positions or IEDs on approach routes.
