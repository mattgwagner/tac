...
**References:** ATP 3-21.8, FM 3-90-1, ATP 3-21.20, ATP 3-90.40, ADRP 1-02

**OPERATIONAL PLAN / ORDER #001 / CODE NAME: "DRAGON ARMY"**
...
**1. Terrain.** The AO consists of flat terrain with sandy soils and dense pine and hardwood forests throughout. Thick vegetation and tree canopy severely limit observation and fields of fire except along improved roads and clearings. The route from the RTI to COP Seggel passes through dense woodlines with limited visibility (under 50 meters off-road), intersected by improved and unimproved roads and trails. Several danger areas exist along the route including road crossings and open areas. COP Seggel is a facility complex situated along Bradenton Avenue at MP 0610 1550. Bradenton Avenue runs north-south through the center of the AO, serving as the primary improved road and avenue of approach. Jacksonville Street runs east-west approximately 150 meters north of the COP. The facility complex includes multiple buildings and hardened structures surrounded by dense woodlines on all sides. Open areas within and immediately surrounding the facility provide limited fields of fire along the road corridors.
...
REAPER forces are an irregular force operating throughout AO HERRERA. Following the host nation withdrawal from COP Seggel, REAPER has expanded operations in the area. They are capable of conducting reconnaissance, small-unit attacks, indirect fire, and coordinated assaults. REAPER has demonstrated interest in controlling key infrastructure to stage their own operations. REAPER is familiar with the road network, woodlines, and facility layout throughout the AO.

**1. Composition.** Estimated squad-sized REAPER element (8-12 personnel) operating in the AO, equipped with small arms (AK-47s), possible mortar or indirect fire capability, IEDs, and communications equipment. A larger REAPER element of up to platoon size may be available to reinforce within 4-6 hours from the north along Jacksonville Street.

**2. Disposition.** REAPER reconnaissance elements are active throughout the AO, monitoring routes between the RTI and COP Seggel. REAPER likely has an observation element near the facility at COP Seggel monitoring the road network, particularly Bradenton Avenue and the road junction at Jacksonville Street (MP 0602 1565). If REAPER has occupied the facility, they will have established hasty defensive positions oriented along Bradenton Avenue and the east-west access roads.

**3. Most Probable Course of Action (MPCOA).** REAPER reconnaissance elements observe and report friendly movement from the RTI toward COP Seggel without engaging. Upon detecting friendly approach to the COP along Bradenton Avenue, REAPER observers withdraw north toward the Jacksonville Street junction or into the woodlines west of the COP and report friendly strength and disposition to higher. REAPER conducts harassing indirect fire from positions north of Jacksonville Street to disrupt occupation and probes the perimeter with small reconnaissance elements to assess defensive posture.

**4. Most Dangerous Course of Action (MDCOA).** REAPER has occupied and fortified COP Seggel as a staging base. Upon friendly approach, REAPER defends the facility while calling for reinforcement from the north. A platoon-sized REAPER element conducts a coordinated counterattack south along Bradenton Avenue and through the woodlines west of the COP, employing indirect fire to suppress defensive positions while assault elements attack from the north and west.

### d. Friendly Forces

**1. Higher Headquarters:** 4th BN – 211th INF.

**2. Battalion Mission.** 4th BN-211th INF conducts stability operations in the Camp Blanding area to deny REAPER freedom of movement and establish conditions for host nation security force return.

**3. Company Mission.** A Company establishes a forward presence in AO HERRERA to deny REAPER freedom of movement and enable follow-on offensive operations. COP Seggel will serve as the company command post and base of operations for sustained operations throughout the AO.

**4. Adjacent Units.** 2nd Platoon is OPCON to battalion reserve and is not available. 3rd Platoon is conducting operations elsewhere in the AO and is not available to support this operation.

### e. Civil Considerations
Host nation security forces recently vacated the facility. Host nation civilians or contractors may be in the surrounding area, particularly along Jacksonville Street and the improved roads east of the COP. Any host nation personnel encountered should be treated respectfully, identified, and reported to higher. Materials and equipment left behind by host nation forces should be inventoried and reported. Avoid damage to facility infrastructure that will be used for sustained operations.
...
A Company seizes and secures COP Seggel (MP 0610 1550) NLT 1300L on 05 MAR 26 in order to establish a forward operating base and enable follow-on operations in AO HERRERA.
...
**1. Rules of Engagement (ROE):**
   ...
   3. Positively identify targets before firing — host nation personnel may be present.
   4. Avoid damage to facility infrastructure that will be used for sustained operations.
...
**4. Reporting:**
   ...
   - **LACE Report:** Upon occupation and every 12 hours thereafter.
   - **CP Operational Report:** Upon establishment of company command post with communications and battle tracking.
...
### a. Logistics
1. Resupply is not expected for a minimum of 48 hours after occupation. Plan accordingly.
2. Meal Cycle: M-M-M. Ensure all personnel carry sufficient rations for 48 hours.
3. Water: Carry maximum water on movement. Additional water resupply available at COP Seggel upon occupation.
4. Class V (ammunition): Carry basic load. Redistribute as needed; report any shortages immediately.
5. Equipment maintenance: Conducted during priorities of work. Inventory and report any usable host nation materials found at the facility.
6. Rest plan: Platoon leader will establish a rest and security rotation that maintains defensive posture while sustaining the force. No more than one-third of the force resting at any time.

### b. Health System Support
1. Platoon CCP moves with the platoon during movement; established within COP Seggel perimeter upon occupation.
2. Aid bag located with PSG.
3. MEDEVAC available via Nine Line request at AXP 1.
4. During movement: stabilize and continue if tactical situation permits; request MEDEVAC if required.
5. At COP: Primary CASEVAC route south along Bradenton Avenue.
...
### a. Command
1. Company Commander at company main CP (not forward).
2. Company XO assumes company command at COP Seggel upon CP establishment.
3. 1st Platoon Leader has tactical command of the movement and seizure.
4. Succession of Command (1st Platoon): PL, PSG, 1st SL, 2nd SL, 3rd SL.

### b. Control
1. Company Main CP: RTI vicinity until COP is established.
2. Company Forward CP: COP Seggel (MP 0610 1550) upon occupation.
